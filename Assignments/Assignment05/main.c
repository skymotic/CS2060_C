...
void setupMode(double *reg1, double *reg2, double *reg3, double *des){
	...
	*des = temp;
	...
	printf("The price of Regular Unlead fuel has been set to: $%.2f\n", reg1);
	printf("The price of Mid-grade Unlead fuel has been set to: $%.2f\n", reg2);
	printf("The price of Premium Unlead fuel has been set to: $%.2f\n", reg3);
	printf("The price of Diesel fuel has been set to: $%.2f\n", des);
	puts("------------------\nExiting Setup Mode\n------------------\n");
}
